...
def main():
    ...
    try:
        while True:
            ...
            hour_digit = seven_segments.generate_seven_segments(hours, 2)
            hour_top_row, hour_middle_row, hour_bottom_row = hour_digit.splitlines()

            minute_digit = seven_segments.generate_seven_segments(minutes, 2)
            minute_top_row, minute_middle_row, minute_bottom_row = minute_digit.splitlines()

            sec_digit = seven_segments.generate_seven_segments(seconds, 2)
